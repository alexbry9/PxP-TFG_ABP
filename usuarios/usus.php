...
if (isset($_POST['descargar'])) {
  ...
  echo 'foreach ($RAIZ IN "'. $varNombre .'", "'. $varNombre2 .'") {
...
<label for="nombre2">Nombre del segundo departamento:</label><input type="text" name="nombre2" id="nombre2"> <br><br>
<?php
echo "Los nombres de los departamentos serán las raices de los nombres de los usuarios"
?>
<br><br>
